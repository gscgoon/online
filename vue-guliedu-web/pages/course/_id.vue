      ...
      <div>
          ...
          <aside class="c-attr-wrap">
              <section class="ml20 mr15">
                  ...
                  <section v-if="courseIsBuy || Number(course.price)==0" class="c-attr-mt">
                      <!-- 给要跳转到的区域的div 设置id ，就可以跳转到对应的区域了 -->
                      <!-- <a href="#player" title="立即观看" class="comm-btn c-btn-3">立即观看</a> -->
                      <a href="#player" title="立即观看" class="comm-btn c-btn-3" >立即观看</a>
                  </section>
                  <section v-else class="c-attr-mt">
                      <a  @click="addOrder()" href="#" title="立即购买" class="comm-btn c-btn-3" >立即购买</a>
                  </section>
              </section>
          </aside>
            ...
            <div class="i-box">
              ...
              <article class="ml10 mr10 pt20">
                ...
                <div class="mt50">
                  ...
                  <section class="mt20">
                      <div class="lh-menu-wrap" id="player">
            ...
            <div>
                ...
                <section class="stud-act-list">
                    <ul style="height: auto;">
                        <li>
                            <div class="u-face">
                                <a :href="'/teacher/'+course.id" target="_blank">
                                    <img :src="course.avatar" width="50" height="50" alt>
                                </a>
                            </div>
                            <section class="hLh30 txtOf">
                                <a :href="'/teacher/'+course.id" class="c-333 fsize16 fl" target="_blank">{{ course.teacherName }}</a>
                            </section>
