  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="总课时">
        <el-input-number :min="0" v-model="courseForm.lessonNum" controls-position="right" placeholder="请填写课程的总课时数"/>
      </el-form-item>
      ...
      <el-form-item label="课程价格">
        <el-input-number :min="0" v-model="courseForm.price" controls-position="right" placeholder="免费课程请设置为0元"/> 元
      </el-form-item>
...
//************************************添加操作******************************************************/
    save(){
      course.addCourse(this.courseForm)
        .then(response =>{
          //返回信息
          this.$message({
            type: 'success',
...
//************************************修改操作******************************************************/
    ...
    update(){
      course.updateCourse(this.courseForm)
        .then(response =>{
          //返回信息
          this.$message({
            type: 'success',
