...
import com.atguigu.serviceAcl.entity.User;
import com.atguigu.serviceAcl.helper.MenuHelper;
import com.atguigu.serviceAcl.helper.PermissionHelper;
import com.atguigu.serviceAcl.mapper.PermissionMapper;
import com.atguigu.serviceAcl.service.PermissionService;
import com.atguigu.serviceAcl.service.RolePermissionService;
import com.atguigu.serviceAcl.service.UserService;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements PermissionService {
    ...
    public List<String> selectPermissionValueByUserId(String id) {
        ...
        if (isSysAdmin(id)) {
            //如果是系统管理员，获取所有权限
            return selectPermissionValueList = baseMapper.selectAllPermissionValue();
        } else {
            return selectPermissionValueList = baseMapper.selectPermissionValueByUserId(id);
        }
    }
    ...
    private boolean isSysAdmin(String userId) {
        ...
        return (null != user && "admin".equals(user.getUsername())) ? true : false;
    }
    ...
    public void doAssign(String roleId, String[] permissionIds) {
        //先根据roleId查看该角色是否存在菜单，如果存在先删除再新增，不存在直接新增
